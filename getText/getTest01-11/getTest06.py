...
class load_book(object):
    def __init__(self, host, pageSize, loops):
        self.b_host = host
        ...
        self.errorurls = [
            ...
            'http://www.xs8.cn/all?pageSize=500&gender=2&catId=-1&isFinish=-1&isVip=-1&size=-1&updT=-1&orderBy=0&pageNum=91']
...
if __name__ == '__main__':
    book = load_book('http://www.xs8.cn', 500, 100)
    # book.contents_load()
    book.isOK()
